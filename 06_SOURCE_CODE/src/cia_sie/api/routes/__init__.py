...
from cia_sie.api.routes.market_intelligence import router as market_intelligence_router
...
api_router.include_router(market_intelligence_router, prefix="/market-intelligence", tags=["Market Intelligence"])
