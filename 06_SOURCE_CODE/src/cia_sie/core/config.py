...
_ENV_FILE = ".env" if os.path.isfile(".env") and os.access(".env", os.R_OK) else None
...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        # Avoid hard failure if .env exists but is not readable in the runtime context.
        env_file=_ENV_FILE,
    ...
    # =========================================================================
    # CORS (Configure for your frontend when connected)
    # =========================================================================
