# Backend code diff report

Source: `chat_history_export/backend_code_extracts_python.md`

Total blocks analyzed: 38
...
- Status: MISMATCH
- Detail: Snippet not found in current file
...
- File: `src/cia_sie/core/enums.py`
- Status: MATCH
- Detail: Exact snippet found in file
...
- File: `src/cia_sie/platforms/kite_intelligence.py`
- Status: MISSING FILE
- Detail: File path not present in repo
...
- File: `src/cia_sie/ai/kite_tools.py`
- Status: MISSING FILE
- Detail: File path not present in repo
...
- File: `src/cia_sie/ai/market_agent.py`
- Status: MISSING FILE
- Detail: File path not present in repo
...
- File: `src/cia_sie/ai/market_intelligence_agent.py`
- Status: MISSING FILE
- Detail: File path not present in repo
...
- File: `src/cia_sie/api/routes/market_intelligence.py`
- Status: MISSING FILE
- Detail: File path not present in repo
...
- File: `src/cia_sie/api/routes/charts.py`
- Status: MISMATCH
- Detail: Snippet not found in current file
