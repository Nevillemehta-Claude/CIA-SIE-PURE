...
class TestSettingsDefaults:
    ...
    def test_default_database_url(self):
        ...
        settings = Settings()
        # Database URL can be SQLite (default) or PostgreSQL (production/Replit)
        # Just verify it's a valid database URL format
    ...
    def test_default_ai_settings(self):
        ...
        settings = Settings()
        # API key may be set via environment variables in production/Replit
        # Just verify the model setting contains claude
